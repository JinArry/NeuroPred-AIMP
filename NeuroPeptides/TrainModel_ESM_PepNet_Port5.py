...
from ESM_PepNet_Port5 import AIMP
import warnings
...
print("Begin Running TrainingModel_ESM_PepNet_Port5")
# Load data
...
for epoch in range(epochs):
    ...
    if valid_acc >= best_acc:
        best_acc = valid_acc
        torch.save(model.state_dict(), f"my_best_model_2_lstm_data_split_train_port5.pth")
    print(
